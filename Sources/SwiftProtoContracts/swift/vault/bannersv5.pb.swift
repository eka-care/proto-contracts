...
public struct Vault_Bannersv5_Banner {
  ...
  public struct Content {
    ...
    public struct Assets {
      ...
      public var bgAsset: Vault_Bannersv5_Banner.Content.Assets.Img {
        get {return _bgAsset ?? Vault_Bannersv5_Banner.Content.Assets.Img()}
      ...
      public var topAsset: Vault_Bannersv5_Banner.Content.Assets.Img {
        get {return _topAsset ?? Vault_Bannersv5_Banner.Content.Assets.Img()}
      ...
      public struct Img {
        ...
        public var image: Vault_Bannersv5_Banner.Content.Assets.Img.OneOf_Image? = nil
        ...
        #if !swift(>=4.1)
          public static func ==(lhs: Vault_Bannersv5_Banner.Content.Assets.Img.OneOf_Image, rhs: Vault_Bannersv5_Banner.Content.Assets.Img.OneOf_Image) -> Bool {
            // The use of inline closures is to circumvent an issue where the compiler
            // allocates stack space for every case branch when no optimizations are
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch (lhs, rhs) {
      ...
      fileprivate var _bgAsset: Vault_Bannersv5_Banner.Content.Assets.Img? = nil
      fileprivate var _topAsset: Vault_Bannersv5_Banner.Content.Assets.Img? = nil
    }
...
extension Vault_Bannersv5_Banner.Content.Assets.Img: @unchecked Sendable {}
extension Vault_Bannersv5_Banner.Content.Assets.Img.OneOf_Image: @unchecked Sendable {}
...
extension Vault_Bannersv5_Banner.Content.Assets.Img: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Vault_Bannersv5_Banner.Content.Assets.protoMessageName + ".Img"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "img"),
    2: .same(proto: "lottie"),
  ]
  ...
  public static func ==(lhs: Vault_Bannersv5_Banner.Content.Assets.Img, rhs: Vault_Bannersv5_Banner.Content.Assets.Img) -> Bool {
