...
public struct Vault_Records_DisplayAsset {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var asset: Vault_Records_DisplayAsset.OneOf_Asset? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Vault_Records_DisplayAsset.OneOf_Asset, rhs: Vault_Records_DisplayAsset.OneOf_Asset) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension Vault_Records_DisplayAsset: @unchecked Sendable {}
extension Vault_Records_DisplayAsset.OneOf_Asset: @unchecked Sendable {}
...
extension Vault_Records_DisplayAsset: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DisplayAsset"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "image"),
    2: .same(proto: "lottie"),
    3: .same(proto: "cta"),
  ...
  public static func ==(lhs: Vault_Records_DisplayAsset, rhs: Vault_Records_DisplayAsset) -> Bool {
