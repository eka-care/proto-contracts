...
type ListIdenticalDocs struct {
	...
	Offset    *int32               `protobuf:"varint,2,opt,name=offset,proto3,oneof" json:"offset,omitempty"` // Offset for next query.
}
...
func (x *ListIdenticalDocs) GetOffset() int32 {
...
var file_vault_identical_docs_proto_rawDesc = []byte{
	...
	0x0a, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00,
